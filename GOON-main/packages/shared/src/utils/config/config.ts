...
export const domain_app_ids = {
    'smarttraderstool.com': 100032,
    'deriv.app': 100032,
    'app.deriv.com': 100032,
    'staging-app.deriv.com': 100032,
    'app.deriv.me': 100032,
    'staging-app.deriv.me': 100032,
    'app.deriv.be': 100032,
    'staging-app.deriv.be': 100032,
    'binary.com': 100032,
    'test-app.deriv.com': 100032,
    'royal-app-seven.vercel.app': 100032,
    'star-eight-ruby.vercel.app': 100032,
    'beleiver.vercel.app': 100032,
    'goon-puce.vercel.app': 100032,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 100032 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 100032;
