...
export const domain_app_ids = {
    'smarttraderstool.com': 100103,
    'deriv.app': 100103,
    'app.deriv.com': 100103,
    'staging-app.deriv.com': 100103,
    'app.deriv.me': 100103,
    'staging-app.deriv.me': 100103,
    'app.deriv.be': 100103,
    'staging-app.deriv.be': 100103,
    'binary.com': 100103,
    'test-app.deriv.com': 100103,
    'royal-app-seven.vercel.app': 100103,
    'star-eight-ruby.vercel.app': 100103,
    'beleiver.vercel.app': 100103,
    'goon-puce.vercel.app': 100103,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 100103 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 100103;
