...
export const domain_app_ids = {
    'smarttraderstool.com': 72091,
    'deriv.app': 72091,
    'app.deriv.com': 72091,
    'staging-app.deriv.com': 72091,
    'app.deriv.me': 72091,
    'staging-app.deriv.me': 72091,
    'app.deriv.be': 72091,
    'staging-app.deriv.be': 72091,
    'binary.com': 72091,
    'test-app.deriv.com': 72091,
    'royal-app-seven.vercel.app': 72091,
    'star-eight-ruby.vercel.app': 72091,
    'beleiver.vercel.app': 72091,
    'goon-puce.vercel.app': 72091,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 72091 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 72091;
